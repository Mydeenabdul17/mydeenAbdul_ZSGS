...
public class Demo {
	...
	public static void myMain()
		...
		Method method1[] = Patterns.class.getDeclaredMethods();
		Method method2[] = Pyramids.class.getDeclaredMethods();
		sort(method1);
		sort(method2);
		...
		do {
			...
			if (input == 0) {
				...
				if(input<=method1.length) {
					method1[input - 1].invoke(new Patterns(), n);
				}else {
					method2[input- 1-method1.length].invoke(new Patterns(), n);
				}
				Thread.sleep(200);
			}
		} while (b);
